...
<div id="kt_header_mobile" class="header-mobile align-items-center  header-mobile-fixed " >
    <!--begin::Logo-->
    <a href="index.html">
        <img alt="Logo" src="<?php echo $logoWhite; ?>"/>
    </a>
    <!--end::Logo-->
            ...
            <div id="kt_header" class="header  header-fixed " >
                ...
                <div class=" container-fluid  d-flex align-items-stretch justify-content-between">
                    ...
                    <div class="topbar">
                        ...
                        <!--begin::CreateMenu-->
                        <?php
                        require "dashboard/createmenu.php";
                        ?>
                        <!--end::CreateMenu-->

                        <!--begin::Notifications-->
                        <?php
                            require "dashboard/notifications.php";
                        ?>
                        <!--end::Notifications-->
            ...
            <div class="footer bg-white py-4 d-flex flex-lg-column " id="kt_footer">
                ...
                <div class=" container-fluid  d-flex flex-column flex-md-row align-items-center justify-content-between">
                    ...
                    <div class="text-dark order-2 order-md-1 font-size-sm">
                        <span class="text-muted font-weight-bold mr-2"><?php echo $copyText; ?></span>
                    </div>
                    <!--end::Copyright-->
...
<!-- begin::User Panel-->
    <?php
        require "dashboard/userpanel.php";
    ?>
<!-- end::User Panel-->
